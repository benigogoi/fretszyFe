...
const StringSelection: React.FC<StringSelectionProps> = ({
    ...
    return (
        <div className={isMobile ? "grid grid-cols-2 gap-2" : "flex flex-col sm:flex-row gap-4 items-center justify-center"}>
            <div>
                <label className="block mb-2 font-medium text-sm sm:text-base">From String</label>
                <Select
                    id="start-string"
            ...
            <div>
                <label className="block mb-2 font-medium text-sm sm:text-base">To String</label>
                <Select
                    id="end-string"
