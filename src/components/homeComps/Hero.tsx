          ...
          <div className="container mx-auto px-6 lg:px-8">
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
              ...
              <div className="lg:w-3/5 text-center lg:text-left px-4 lg:px-6">
                ...
                <Link
                  to="/tools"
                  className="inline-block bg-white hover:bg-gray-100 text-blue-600 font-medium py-3 px-8 rounded-md transition-colors shadow-lg transform hover:scale-105 duration-200"
                >
              ...
              <div className="lg:w-2/5 px-4 lg:px-6 flex items-center justify-center relative z-10">
                ...
                <div className="relative">
                  ...
                  <div
                    className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-1/4 w-96 h-96"
                    style={{
                      background:
                  ...
                  {/* Dynamic light beam */}
                  <div className="absolute top-0 left-1/2 transform -translate-x-1/2 -translate-y-32 w-64 h-64 bg-gradient-to-b from-white via-white to-transparent opacity-10 blur-md z-0"></div>

                  {/* Main image */}
                  <img
                    src={heroImage}
                    alt="Guitarist playing with energy"
                    className="relative z-20 h-auto max-h-[500px] object-contain"
                    style={{
                  ...
                  <div className="absolute top-1/3 right-0 w-32 h-32 bg-red-500 rounded-full mix-blend-screen opacity-30 blur-2xl z-10"></div>
                  <div className="absolute bottom-1/4 left-0 w-24 h-24 bg-blue-500 rounded-full mix-blend-screen opacity-30 blur-2xl z-10"></div>
                </div>
              </div>
            </div>
          </div>
